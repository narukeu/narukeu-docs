...
基于 Rollup 的前端打包器项目。借鉴了 Webpack 的 Loader 和 Plugin 设计思想，但同时和 Rollup Build Hooks 完全兼容。

开发的初衷是，我比较喜欢 Next.js，但是，Turbopack 目前和 Next.js 仍然紧密绑定，无法单独使用，而 Vite 又不够自定义。
